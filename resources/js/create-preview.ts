// Live strip preview on the create form: redraws a faithful strip (same
// compose modules the booth uses) as the owner changes layout, colour, and
// caption, with placeholder cells standing in for the guests' photos.
...
const preview = document.querySelector<HTMLImageElement>('#preview-strip')!;
...
function placeholderShot(width: number, height: number, index: number): HTMLCanvasElement {
